<x-layouts.app title="Edit Jadwal Kuliah - Aviona Sync">
    <div class="max-w-2xl space-y-6">
        <div>
            <a href="{{ route('college-schedule.show', $schedule) }}" class="text-sm font-medium text-blue-600 hover:text-blue-700">&larr; Kembali</a>
            <h1 class="mt-2 text-2xl md:text-3xl font-bold tracking-tight text-slate-900">Edit Jadwal Kuliah</h1>
        </div>
