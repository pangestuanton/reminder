<x-layouts.app title="Integrasi - Aviona Sync">
    <div>
        <h1 class="text-2xl md:text-3xl font-bold tracking-tight text-slate-900">Integrasi</h1>
        <p class="mt-1 text-sm text-slate-500">Hubungkan layanan Google untuk sinkronisasi otomatis.</p>
    </div>
        ...
        <x-card>
            <div class="flex items-start justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-slate-900">Google Classroom</h3>
                        <p class="text-sm text-slate-500">Impor kursus, tugas, dan status pengumpulan</p>
                    </div>
                </div>
                @if ($hasClassroom)
                    <span class="rounded-full bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-700">Terhubung</span>
                @else
                    <span class="rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold text-slate-500">Tidak terhubung</span>
                @endif
            </div>
            <div class="mt-4">
                @if ($hasClassroom)
        ...
        <x-card>
            <div class="flex items-start justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-slate-900">Google Calendar</h3>
                        <p class="text-sm text-slate-500">Impor acara dan ekspor tugas & jadwal kuliah</p>
                    </div>
                </div>
                @if ($hasCalendar)
                    <span class="rounded-full bg-emerald-50 px-3 py-1 text-xs font-semibold text-emerald-700">Terhubung</span>
        ...
        <x-card>
            <div class="flex items-start justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-lg font-semibold text-slate-900">Telegram Bot</h3>
                        <p class="text-sm text-slate-500">Pengingat dan agenda harian via Telegram</p>
                    </div>
                </div>
