...
<x-layouts.app title="{{ $isEdit ? 'Edit Jadwal' : 'Tambah Jadwal' }} - Aviona Sync">
    <div class="max-w-3xl space-y-6">
        <div>
            ...
            <h1 class="mt-3 text-2xl md:text-3xl font-bold tracking-tight text-slate-900">{{ $isEdit ? 'Edit Jadwal' : 'Tambah Jadwal' }}</h1>
            <p class="mt-1 text-sm text-slate-500">Periksa kembali data jadwalmu sebelum menyimpan.</p>
        </div>
        ...
        <x-card>
            <form method="POST" action="{{ $route }}" class="space-y-5">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                    ...
                    <div>
                        <label class="mb-2 block text-sm font-medium text-slate-700">Waktu Pelaksanaan</label>
                ...
                <div>
                    <label class="mb-2 block text-sm font-medium text-slate-700">Lokasi atau Link</label>
